...
import controllers.ListaCarrerasController;
...
import util.ListaCarreraTableModel;

public class ListaCarrerasFrame extends javax.swing.JFrame {

    public ListaCarrerasController controller;

    public ListaCarrerasFrame(ListaCarrerasController controller) {
    ...
    public void setupTable(List<ComponenteUniversitario> listadoCarrera) {
        limpiarTabla();

        ListaCarreraTableModel model = new ListaCarreraTableModel(listadoCarrera);
        carreras_table.setModel(model);
    ...
    public void limpiarTabla() {
        ...
        if (carreras_table.getModel().getRowCount() > 0) {
            TableColumnModel columnModel = carreras_table.getColumnModel();
    ...
    private void configurarColumnas() {
        ...
        for (int x = 0; x < carreras_table.getColumnCount(); x++) {
            if (x != 3) {
                carreras_table.getColumnModel().getColumn(x).setCellRenderer(centerRenderer);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        title_label.setText("Lista de carreras");
        ...
        carreras_table.setGridColor(new java.awt.Color(37, 92, 125));
        carreras_table.setRowHeight(48);
        carreras_table.setShowGrid(true);
        carreras_table.setUpdateSelectionOnSort(false);
        carreras_table.setVerifyInputWhenFocusTarget(false);
        jScrollPane1.setViewportView(carreras_table);
