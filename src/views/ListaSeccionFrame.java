...
public class ListaSeccionFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        secciones_table.setGridColor(new java.awt.Color(37, 92, 125));
        secciones_table.setRowHeight(48);
        secciones_table.setShowGrid(true);
        secciones_table.setUpdateSelectionOnSort(false);
        secciones_table.setVerifyInputWhenFocusTarget(false);
